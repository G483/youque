...
var _SearchWrap = __webpack_require__(28);

var _SearchWrap2 = _interopRequireDefault(_SearchWrap);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var wrapper = document.getElementById("app");
wrapper ? _reactDom2.default.render(_react2.default.createElement(_SearchWrap2.default, null), wrapper) : false;
...
var SearchWrap = function (_React$Component) {
  _inherits(SearchWrap, _React$Component);

  function SearchWrap(props) {
    _classCallCheck(this, SearchWrap);

    return _possibleConstructorReturn(this, (SearchWrap.__proto__ || Object.getPrototypeOf(SearchWrap)).call(this, props));
  }

  _createClass(SearchWrap, [{
    key: 'render',
...
var SearchBar = function (_React$Component) {
  ...
  _createClass(SearchBar, [{
    ...
    value: function handleSubmit(e) {
      ...
      _axios2.default.get('/api/youtube-search/' + this.state.value).then(function (res) {
        console.log(res);
      }).catch(function (err) {
        console.log(err);
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('button', { type: 'submit', value: 'submit', className: 'd-none' })
          )
        )
      );
    }
